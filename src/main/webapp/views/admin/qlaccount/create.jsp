...
<c:if test="${ !empty sessionScope.error }">
    ...
    <form:form action="${ pageContext.request.contextPath }/account/store" method="post" modelAttribute="account" enctype="multipart/form-data" >
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="file" name="photo_file" placeholder="Vui lòng chọn Avatar">
                </div>
            </div>
